...
<br />
    ...
    <asp:TextBox ID="TextBoxFirstName" runat="server" CssClass="input-field2" TextMode="SingleLine" />
    <asp:TextBox ID="TextBoxLastName" runat="server" CssClass="input-field2" TextMode="SingleLine" />
    <br />
    <asp:Label ID="LabelCNIC" runat="server" Text="CNIC:" />
    <asp:TextBox ID="TextBoxCNIC" runat="server" CssClass="input-field" TextMode="SingleLine" />
    <br />
    <asp:Label ID="LabelPhoneNo" runat="server" Text="Phone no:" />
    <asp:TextBox ID="TextBoxPhoneNo" runat="server" CssClass="input-field" TextMode="SingleLine" />
    <br />
    ...
    <asp:TextBox ID="TextBoxAddress" runat="server" CssClass="input-field" TextMode="SingleLine" />
    <br />
    <asp:Label ID="LabelCity" runat="server" Text="City:" />
    <asp:TextBox ID="TextBoxCity" runat="server" CssClass="input-field" TextMode="SingleLine" />
    <br />
    <asp:Label ID="LabelCountry" runat="server" Text="Country:" />
    <asp:TextBox ID="TextBoxCountry" runat="server" CssClass="input-field" TextMode="SingleLine" />
    <br />
    <asp:Label ID="LabelBloodGroup" runat="server" Text="Blood Group:" />
    <asp:TextBox ID="TextBoxBloodGroup" runat="server" CssClass="input-field" TextMode="SingleLine" />
    <br />
    <asp:Label ID="LabelDOB" runat="server" Text="D.O.B" />
    <asp:TextBox ID="TextBoxDOB" runat="server" CssClass="input-field" TextMode="Date" />
    <br />
    <asp:Label ID="LabelARN" runat="server" Text="ARN" />
    <asp:TextBox ID="TextBoxARN" runat="server" CssClass="input-field" TextMode="Number" />
    <br />
    <asp:Label ID="LabelRollNo" runat="server" Text="Roll no:" />
    <asp:TextBox ID="TextBoxRollNo" runat="server" CssClass="input-field" TextMode="SingleLine" />
    <br />
    <asp:Label ID="LabelRegDate" runat="server" Text="Reg. Date" />
    <asp:TextBox ID="TextBoxRegDate" runat="server" CssClass="input-field" TextMode="Date" />
    <br />
    <asp:Label ID="LabelDegree" runat="server" Text="Degree: " />
    <asp:DropDownList ID="DropDownListDegree" runat="server" CssClass="input-field">
        <asp:ListItem Value="CS">CS</asp:ListItem>
        <asp:ListItem Value="DS">DS</asp:ListItem>
        <asp:ListItem Value="AI">AI</asp:ListItem>
    </asp:DropDownList>
    <br />
    <asp:Label ID="LabelCampus" runat="server" Text="Campus: " />
    <asp:DropDownList ID="DropDownListCampus" runat="server" CssClass="input-field">
    ...
    <br />
    <asp:Label ID="LabelFatherName" runat="server" Text="Father Name:" />
    <asp:TextBox ID="TextBoxFatherFirstName" runat="server" CssClass="input-field2" TextMode="SingleLine" />
    <asp:TextBox ID="TextBoxFatherLastName" runat="server" CssClass="input-field2" TextMode="SingleLine" />
    <br />
    <asp:Label ID="LabelFatherCNIC" runat="server" Text="Father's CNIC:" />
    <asp:TextBox ID="TextBoxFatherCNIC" runat="server" CssClass="input-field" TextMode="SingleLine" />
    <br />
    <asp:Label ID="LabelHomePhoneNo" runat="server" Text="Home Phone no:" />
    <asp:TextBox ID="TextBoxHomePhoneNo" runat="server" CssClass="input-field" TextMode="SingleLine" />
    <br />
    <asp:Button ID="RegisterButton" runat="server" Text="Register" CssClass="login" OnClick="RegisterButton_Click" />
</div>
